            ...
            {record
              ? filteredColumns.map((column, index) => (
                  <div class="showRecordField" key={index}>
                    ...
                    <div class="formValue">
                      {getFormattedValue(column, record, config, false) || '-'}
                    </div>
                  </div>
                ))
              : null}
              ...
              {view.recordViewPanels.map((panel, index) => (
                <div class="panel" key={index}>
                  <div class="panelHeader">
                    ...
                    <div class="viewHeaderActions">
                      {panel.folded ? (
                        <div class="button smallButton unfoldPanel">
                          Afficher
                        </div>
                      ) : null}
                      {panel.canCreate ? (
                        <Link
                          to={`/createRecord/${viewIndex}/${index}/${recordId}`}
                        >
                      ...
                      {panel.canDownload && panel.type === 'table' ? (
                        <DownloadTablePanelButton
                          record={record}
                          panel={panel}
                        />
                      ) : null}
